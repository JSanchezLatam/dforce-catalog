...
- [ ] 2.0 Branch `vehicles/wu2-collection-write-and-search` off a clean `main`, only after PR #1 has merged (sequential-to-`main`, see the Chain strategy row).
...
- [ ] 2.15 Open PR #2 → base `main`. If slice-1 changes appear in this diff, the branch was cut before PR #1 merged (see 2.0).
