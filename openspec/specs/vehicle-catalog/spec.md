# Spec: vehicle-catalog

This spec is created whole by `service-orders-search-and-vehicle-catalog` (WU3). The
catalog is curated in-repo rather than sourced from NHTSA vPIC: vPIC returns 58
Toyota models and contains none of Hilux, Fortuner, Land Cruiser Prado or Rush,
because it is built on US registrations. This is a Panama workshop.
